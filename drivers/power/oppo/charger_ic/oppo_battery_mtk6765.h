...
#include "../../../upload_kernel/drivers/power/supply/mediatek/misc/mtk_gauge_time_service.h"

#include "../../../upload_kernel/drivers/power/supply/mediatek/charger/charger_class.h"

/* PD */
#include "../../../upload_kernel/drivers/misc/mediatek/typec/tcpc/inc/tcpm.h"

#include "../../../upload_kernel/drivers/misc/mediatek/typec/tcpc/inc/mtk_direct_charge_vdm.h"

struct charger_manager;
#include "../../../upload_kernel/drivers/power/supply/mediatek/charger/mtk_pe_intf.h"
#include "../../../upload_kernel/drivers/power/supply/mediatek/charger/mtk_pe20_intf.h"
#include "../../../upload_kernel/drivers/power/supply/mediatek/charger/mtk_pdc_intf.h"
...
#ifdef ODM_HQ_EDIT
/* Yi.Zhou@ODM.HQ.BSP.CHG.Basic 2019.11.08 add bq2560x recharge interface */
extern int bq2560x_set_rechg_voltage(struct charger_device *, int);
extern int bq2560x_reset_charger(struct charger_device *); /* Yi.Zhou@ODM.HQ.BSP.CHG.Basic 2019.11.19 add bq2560x reset interface */
extern int bq2560x_check_resume(struct charger_device *); /* Yi.Zhou@ODM.HQ.BSP.CHG.Basic 2019.11.20 for check charger resume interface */
#endif
...
#endif /* __OPPO_BATTERY_MTK6779_H__ */
