...
#if CONFIG_OPPO_BSP_SECCOM_PLATFORM == 6763 || CONFIG_OPPO_BSP_SECCOM_PLATFORM == 6771 || CONFIG_OPPO_BSP_SECCOM_PLATFORM == 6779 || CONFIG_OPPO_BSP_SECCOM_PLATFORM == 6765
#include <sec_boot_lib.h>
#else CONFIG_OPPO_BSP_SECCOM_PLATFORM == 855 || CONFIG_OPPO_BSP_SECCOM_PLATFORM == 6125 || CONFIG_OPPO_BSP_SECCOM_PLATFORM == 7150
...
|| CONFIG_OPPO_BSP_SECCOM_PLATFORM == 7150/* sdm660, sdm845, sdm670, sdm710, sdm855 sm6125 sm7150 */
